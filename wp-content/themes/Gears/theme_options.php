...
$options = array (
	...
	array(  "name" => "Home page content",
			"desc" => "Select between cars listings or blog posts to display on homepage",
			"id" => $shortname."_home",
            "type" => "select",		
			"options" => array('cars', 'blog'),		
   		    "std" => ""),
	
	array(  "type" => "close"),

    array(  "name" => "Featured cars slider",
            "type" => "title",
			"desc" => "",
       		),
	...
	array( 	"name" => "Number of featured cars",
	...
	array( 	"name" => "Agent name",
			"desc" => "Enter the agent name.",
			"id" => $shortname."_my_name",
			"std" => "",
            "type" => "text"), 		
	
	array( 	"name" => "Agent phone number",
			"desc" => "Enter the phone number of the agent.",
			"id" => $shortname."_my_phone",
			"std" => "",
            "type" => "text"), 		
			
	array( 	"name" => "Agent email",
			"desc" => "Enter the agent email.",
			"id" => $shortname."_my_email",
			"std" => "",
            "type" => "text"), 			

	array( 	"name" => "Agent twitter",
			"desc" => "Enter the agent twitter.",
			"id" => $shortname."_my_twit",
			"std" => "",
            "type" => "text"), 		
